    ...
    for x in range(len(lis)):
        ...
        for a in range(len(lis)):
            ...
            if lis[x][4]==lis[a][4] and m==0:
                ...
                m=1
                return 0
            if m==0 and ((lis[x][0]=='link' and lis[a][0]=='link') or (lis[x][0]=='unlink' and lis[a][0]=='unlink')) and ((lis[x][1][1]==lis[a][1][1] and lis[x][2][1]==lis[a][2][1]) or (lis[x][1][1]==lis[a][2][1] and lis[x][2][1]==lis[a][1][1])):
                remfrom(lis[x],clues)
                m=1
                return 0
